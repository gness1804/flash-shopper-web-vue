<template>
  <div class="modal timer-modal">
    ...
    <div class="timer-container">
      <p class="count-from-text">Count down from:</p>
      <div class="dropdowns-one">
        <select class="timer-numbers-select" v-model="timeOne">
          <option
        ...
        <select class="units-dropdown" v-model="unitsOne">
          <option>seconds</option>
          <option>minutes</option>
          <option>hours</option>
        </select>
      </div>
      <div class="dropdowns-two">
        <select class="timer-numbers-select" v-model="timeTwo">
          <option
        ...
        <select class="units-dropdown" v-model="unitsTwo">
          <option>seconds</option>
          <option>minutes</option>
          <option>hours</option>
        </select>
      </div>
      <button class="button timer-button" v-on:click="startTimer">Go!</button>
    </div>
  </div>
</template>
